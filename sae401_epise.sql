...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 22 sep. 2025 à 12:58
...
(16, 'AMIN HANDOYO', 'Camélia', 'camhdyo@gmail.com', '998696', 0, '2025-09-01 16:47:21', NULL),
(17, 'AMIN HANDOYO', 'Camélia', 'camhdyo@gmail.com', '998696', 0, '2025-09-01 17:02:18', NULL);
...
CREATE TABLE IF NOT EXISTS `carrousel` (
  ...
  `categorie` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'accueil',
  PRIMARY KEY (`id`)
...
(26, 30, 1, 'Bonbons Dragibus', 5, NULL, '0000-00-00', '', '2025-09-01 09:48:58', 0);
...
(17, 'Gel douche', 'Gel douche Ushuaïa Polynésie', 18, 'images/gel_douche_polynesie.jpg', 3),
(18, 'Boîte de viande', 'Conserve de viande', 8, 'images/boite_viande.jpg', 1),
(19, 'Pommes', 'Pommes Gala fraîches', 439, 'images/pommes.png', 1),
...
(3, 13, '2025-08-25 02:36:40', 'en_attente'),
(4, 30, '2025-09-01 10:02:38', 'en_attente'),
(5, 30, '2025-09-01 10:13:21', 'en_attente'),
(6, 30, '2025-09-21 03:43:08', 'en_attente');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `role` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'particulier',
...
INSERT INTO `users` (`id`, `numero_etudiant`, `prenom`, `nom`, `email`, `token`, `password`, `adherent`, `role`, `reset_token`, `reset_token_expire`) VALUES
(23, NULL, 'ticulier', 'Par', 'par@mail.com', '', '$2y$10$9Z9iUbCZPoMfas7KCsIFzuAU7O9IGlBFswhej2z5rsOU3Q6.x6ahC', 0, 'particulier', NULL, NULL),
(24, NULL, 'dredi', 'ven', 'vendredi@mail.com', '', '$2y$10$yrzMVIlZQv7mlPZJ3D9NAubhNQS8Z/OGBmkCZvCpuURDRFdYczwqi', 0, 'particulier', NULL, NULL),
(26, NULL, 'Culier', 'Par', 'particulier@mail.com', '', '$2y$10$MHzScylmXt1/M/9ag9Vhy.MYH2SeRAkE.MbwamjFTbYI4Pmwkyph2', 0, 'particulier', NULL, NULL),
(27, NULL, 'Mardi', 'Mar', 'mardi@mail.com', '', '$2y$10$o7mdjNRKBVKhLd9aQupV7uf3/RpkjaAqH3NuwXRmNsThZo4sTO4ki', 0, 'particulier', NULL, NULL),
(28, '25500', 'Mer', 'Credi', 'mercredi@mail.com', '', '$2y$10$KpP8s6E2WKp7KkPm/M4SeeN6vPwdt4v/QbJgYCGtaBI1sdrOe.LYe', 1, 'etudiant', NULL, NULL),
(29, '3456', 'liz', 'am', 'liz@gmail.com', '', '$2y$10$klgglNNPGtcF6.rHZdtnm.IFX.bx.GG5BiN2r.D9GA2aXG651jOLu', 1, 'etudiant', NULL, NULL),
(30, '36242', 'Camélia', 'AMIN HANDOYO', 'camhdyo@gmail.com', 'a8c7bd19305b863273d1edfe526be3d795b57e009b90649e7602d54f8d7cd39c', '$2y$10$cmiJZQctaqXDQjO9ydUZcuTl36fFvEoNn354CHPvgQA3biJzUSmtW', 1, 'etudiant', NULL, NULL),
(32, '5678', 'Camélia', 'AMIN HANDOYO', 'ygjjk16@gmail.com', 'dd3c5a64496b5d5dfe4b6746a816dc58902874a3723fee4365c3498335eef994', '$2y$10$j6qcyjBiAaIsd0SQ/UO/vuIwxkgEJEI9C0yzH4/d67Us4CHpjkVkW', 0, 'etudiant', NULL, NULL);
